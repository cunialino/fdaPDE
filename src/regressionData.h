...
//! A basic version of the constructor.
		...
		*/
		...
		inline UInt const getNumberofSpaceObservations() const {return observations_.size()/(incidenceMatrixTime_.rows() == 0 ? time_locations_.size() : incidenceMatrixTime_.rows());}
