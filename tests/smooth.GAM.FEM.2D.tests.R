...
image(FEM(output_CPP$fit.FEM$coeff[,outupt_CPP$bestlambda[1]],FEMbasis))
image(FEM(sol_nodes, FEMbasis))
#### Test 1.3: With stochastic GCV
GCVmethod = 'Stochastic'
GCVFLAG=T
output_CPP <- fdaPDE::smooth.FEM(location = loc, observations = as.numeric(response), FEMbasis =FEMbasis, covariates = NULL, DOF.evaluation = "stochastic", lambda.selection.lossfunction = "GCV",
